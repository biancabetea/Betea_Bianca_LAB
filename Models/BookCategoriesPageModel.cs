...
namespace Betea_Bianca_LAB2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
            ...
            public void PopulateAssignedCategoryData(Betea_Bianca_LAB2Context context, Book book)
            {
            ...
            public void UpdateBookCategories(Betea_Bianca_LAB2Context context, string[] selectedCategories, Book bookToUpdate)
            {
